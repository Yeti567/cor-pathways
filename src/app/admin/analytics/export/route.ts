...
import { buildAnalyticsReportCsv, reportCsvFilenameSegment } from "@/lib/report-export";
...
export async function GET(request: Request) {
  ...
  const csv = buildAnalyticsReportCsv({
    ...
    analyticsFormIds: reportData.analyticsFormIds,
    analyticsSubmissionIds: reportData.analyticsSubmissionIds,
    dateRangeLabel,
  ...
  return new Response(csv, {
    headers: {
      "content-disposition": `attachment; filename="form-item-analytics-${filenameRange}.csv"`,
