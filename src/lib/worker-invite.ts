...
export function buildWorkerInviteEmail(params: {
  ...
  const subject = `You are invited to ${company} on Cor Pathways`;

  const text = [
    `Hi ${firstName},`,
    "",
    `${company} has invited you to Cor Pathways. Click the link below to accept your invitation and set up your account:`,
    "",
    params.actionLink,
    "",
  ...
  const html = [
    ...
    `<p style="font-size:16px;line-height:1.5;"><strong>${safeCompany}</strong> has invited you to Cor Pathways. Accept your invitation and set up your account:</p>`,
    ...
    '<p style="font-size:13px;color:#64748b;">Cor Pathways</p>',
    "</div>",
  ].join("");
